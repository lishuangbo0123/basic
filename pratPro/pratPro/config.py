...
IS_GET_COMMENT = 1  #是否抓取评论
IS_GET_QA = 1  #是否抓取qa
SPIDER_LIST_PAGE = 10 #爬取页数 列表页的页数
SPIDER_COMMENT_LIST_PAGE = 5 #爬取页数 评论列表页的页数
SPIDER_QA_LIST_PAGE = 10 #爬取页数 QA列表页的页数
SPIDER_QA_DETAIL_LIST_PAGE = 10 #爬取页数 QA详情列表页的页数
IS_USE_PROXY = 0 #是否使用代理
IS_START_FROM_LIST = 1 #是否从列表开始爬
IS_USE_REDIS = 1 #是否使用redis
CHROME_EXECUTABLE_PATH = os.path.dirname(__file__) + '/chromedriver'
# print(CHROME_EXECUTABLE_PATH)
IS_SELENIUM_LOGGING = 1 #是否关闭打印selenium日志
CHROME_DATA_PATH_LOCAL = ''
DOWNLOAD_PATH = os.path.dirname(__file__)
CURRENT_SITE = 0 #0美国  1加拿大  2英国   3日本
POST_CODE_LIST = ['90001','90001','90001','90001']
POST_CODE = POST_CODE_LIST[CURRENT_SITE]
